...
/* 			if (!$thisbutton.attr('data-product_id')) return true; */
			...
			if (!$thisbutton.parent().attr('data-product_id')) return true;
			...
			var data = {
				...
				product_id: 	$thisbutton.parent().attr('data-product_id'),
				quantity:       $thisbutton.parent().attr('data-quantity')
			};
			...
			$.post( woocommerce_params.ajax_url, data, function( response ) {
				...
				if ( woocommerce_params.cart_redirect_after_add == 'yes' ) {
					...
					// View cart text
					// DISABLE add "view cart" text after button clicked.
					/*
