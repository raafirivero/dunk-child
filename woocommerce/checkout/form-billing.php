...
<?php if ( ! is_user_logged_in() && $checkout->enable_signup ) : ?>
	...
	<div class="create-account">
		...
		<p><?php _e( '**Creating an account is required to join to The Tops Club. It\'s how we tell you about the hotness.** If you are a returning customer please login at the top of the page.', 'woocommerce' ); ?></p>
